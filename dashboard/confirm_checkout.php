                      ...
                      <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                              ...
                              ?>
                                <tr>
                                  ...
                                  <input type="hidden" name="class" value="[<?php echo $objResult['ol_subject_abbrev']; ?>]<?php echo $objResult['ol_subject_name']; ?>">
                                  <td><?php echo $objResult['ol_class_date']; ?></td>
                                  <td><?php echo $objResult['ol_class_time']; ?></td>

                                  <td class="text-center"><?php echo number_format($objResult["ol_subject_price"]); ?></td>
                                  <td class="text-center">บาท</td>
                                </tr>
                              <?php } }?>
                                <tr>
                                  <th colspan="4" style="text-align: right; font-weight: bold; background: transparent; border-bottom: 2px solid transparent;">ลดราคา</th>
                                  <th style="text-align: center; font-weight: bold;" >-</th>
                                  <th style="text-align: center;">บาท</th>
                                </tr>
                                <tr>
                                  <th colspan="4" style="text-align: right; font-weight: bold; background: transparent; border-bottom: 2px solid transparent;">รวม</th>
                                  <th style="text-align: center; font-weight: bold;" ><?php echo number_format($SumTotal,2);?></th>
                                  <th style="text-align: center;">บาท</th>
                                </tr>
                                <tr>
                                  <th colspan="4" style="text-align: right; font-weight: bold; background: transparent; border-bottom: 2px solid transparent;">ภาษีมูลค่าเพิ่ม</th>
                                  <th style="text-align: center; font-weight: bold;" >-</th>
                                  <th style="text-align: center;">%</th>
                                </tr>
                                <tr>
                                  <th colspan="4" style="text-align: right; font-weight: bold; background: transparent; border-bottom: 2px solid transparent;">ราคารวมทั้งหมด</th>
                                  <th style="text-align: center; font-weight: bold;" ><?php echo number_format($SumTotal,2);?></th>
                                  <input type="hidden" name="amount" value="<?php echo $SumTotal;?>">
                                  <th style="text-align: center;">บาท</th>
                                </tr>
                              </tbody>
                          ...
                          <?php
                            ...
                            {
                          ?>
                            <button type="submit" class="btn btn-dark btn-round">ยืนยันและชำระเงิน</button>
                          <?php
                            }
                          ?>
                        </div>
