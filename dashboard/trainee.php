...
<body class="">
  <div class="wrapper">
    <?php $page = 'trainee'; include("menu_trainee.php"); ?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">AMCOL Online Class Dashboard</a>
          </div>
              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">จำนวนห้องเรียนออนไลน์ทั้งหมด</p>
                      <p class="card-title">
                        <?php 
                        
                          $strSQLrcd = "SELECT * FROM ol_class";
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">จำนวนห้องเรียนออนไลน์วันนี้</p>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">จำนวนห้องที่เรียนจบแล้วทั้งหมด</p>
                      <p class="card-title">0<p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">วิดีโอ Backup ห้องเรียนทั้งหมด</p>
                      <p class="card-title">0<p>
                    </div>
                  </div>
                </div>
